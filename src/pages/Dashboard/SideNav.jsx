      ...
      <div className="flex flex-col w-16  md:w-64 h-screen py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700">
        ...
        >
          <img
            ...
            alt="Flowbite Logo"
          />
          <span className="self-center text-[#297B77] text-xl font-semibold whitespace-nowrap dark:text-white hidden md:block">
            Get Ride
          </span>
        </Link>
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            <Link
              className="flex items-center px-4 py-2 text-gray-700  dark:bg-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
              to="/"
            >
              <svg
                className="w-5 h-5"
              ...
              <span className="mx-4 font-medium hidden md:block">Home</span>
            </Link>
            ...
            >
              ...
              <span className="mx-4 font-medium hidden md:block">Buyers</span>
            </Link>
            ...
            >
              ...
              <span className="mx-4 font-medium hidden md:block">Sallers</span>
            </Link>
            {/* ====Reported==== */}
            <Link
              className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
